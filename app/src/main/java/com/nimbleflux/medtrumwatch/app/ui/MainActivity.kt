...
import com.nimbleflux.medtrumwatch.app.service.GlucosePollingService
import com.nimbleflux.medtrumwatch.app.viewmodel.MainViewModel
                ...
                when {
                    ...
                    state.selectedProviderId != null -> {
                        ...
                        LoginScreen(
                            ...
                            authType = config?.authType ?: com.nimbleflux.medtrumwatch.shared.provider.AuthType.USERNAME_PASSWORD,
